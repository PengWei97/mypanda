...
class CPKalidindiFullCoupledUpdate;

/**
 * CPKalidindiFullCoupledUpdate uses the multiplicative decomposition of the
...
class CPKalidindiFullCoupledUpdate : public CPStressFullCoupledUpdateBase
{
public:
  static InputParameters validParams();

  CPKalidindiFullCoupledUpdate(const InputParameters & parameters);
...
protected:
  ...
  // reset the size of the material property vectors
  void resetQpStatefulProperties(const unsigned int & op_index) override;
  ...
  // resets the slip system resistance to the initial value
  void resetInitialConstitutiveVariableValues() override;
