...
/**
 * ComputeMultiCPStress (used together with CrystalPlasticityStressUpdateBase)
 ...
 */
class ComputeMultiCPStress : public ComputeFiniteStrainElasticStress
{
public:
  static InputParameters validParams();

  ComputeMultiCPStress(const InputParameters & parameters);
