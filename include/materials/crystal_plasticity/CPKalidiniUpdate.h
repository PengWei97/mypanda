...
class CPKalidiniUpdate;

/**
 * CPKalidiniUpdate uses the multiplicative decomposition of the
...
class CPKalidiniUpdate : public CrystalPlasticityStressUpdateBase
{
public:
  static InputParameters validParams();

  CPKalidiniUpdate(const InputParameters & parameters);
