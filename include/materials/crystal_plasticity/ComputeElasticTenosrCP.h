...
/**
 * ComputeElasticTenosrCP defines an elasticity tensor material
 ...
 */
class ComputeElasticTenosrCP : public ComputeElasticityTensor
{
public:
  static InputParameters validParams();

  ComputeElasticTenosrCP(const InputParameters & parameters);
