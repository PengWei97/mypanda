# test_anisotropy_v1: 修改 inl 的取向差 - 3, stored_factor = 5.0
# test2_anisotropy: stored_factor = 5.0
# test4_anisotropy: do not considering stored energy
# test5_anisotropy: modify PolyStoredEnergyEBSDAction ~ _D_stored_energy
# test6_anisotropy: delta_rho
# test7_anisotropy: local3

# exp_10min_local3

# 

my_filename = "test7_anisotropy"
my_filename2 = "test7_anisotropy"
...
[Mesh]
  [ebsd_mesh]
    ...
    # file = ./test_isotropy_v1/out_test_isotropy_v1_cp/0000-mesh.cpa.gz
    # EBSD Data with GNDs during isothermal annealing with GNDs at 700℃
    filename = Ni_10min_local3_rho.inl # Ni_10min_local2_rho.inl
  []
