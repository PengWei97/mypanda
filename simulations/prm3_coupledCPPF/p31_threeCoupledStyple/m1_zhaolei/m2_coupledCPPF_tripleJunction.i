my_filename = "s1_fullCoupledCPPF_triJunction"
...
[Kernels]
  ...
  [../]
  [./AC_ElasticDrivingForce_gr2]
    type = ACGrGrDeformationEnergyDrivingFC
    variable = gr1
    D_deformation_energy_name = 'delastic_energy/dgr2'
  [../]
  ...
  [../]
  [./AC_PlasticDrivingForce_gr2]
    type = ACGrGrDeformationEnergyDrivingFC
    variable = gr1
    D_deformation_energy_name = 'dplastic_energy/dgr2'
  [../]
[]
...
[Materials]
  ...
  [./stress]
    ...
    output_properties = 'elastic_energy_gr0 elastic_energy_gr1 elastic_energy_gr2'
    outputs = my_exodus
  [../]
  [./trial_xtalpls]
  ...
  [./deformation_energy]
    ...
    output_properties = 'elastic_energy delastic_energy/dgr0  delastic_energy/dgr1 delastic_energy/dgr2 plastic_energy dplastic_energy/dgr0  dplastic_energy/dgr1 dplastic_energy/dgr2'
    outputs = my_exodus
  [../]
