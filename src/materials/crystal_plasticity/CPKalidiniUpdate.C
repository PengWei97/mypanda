...
CPKalidiniUpdate::CPKalidiniUpdate(
...
void
CPKalidiniUpdate::initQpStatefulProperties()
{
...
void
CPKalidiniUpdate::setInitialConstitutiveVariableValues()
{
...
void
CPKalidiniUpdate::setSubstepConstitutiveVariableValues()
{
...
bool
CPKalidiniUpdate::calculateSlipRate()
{
  for (const auto i : make_range(_number_slip_systems))
  {
...
void
CPKalidiniUpdate::calculateEquivalentSlipIncrement(
...
void
CPKalidiniUpdate::calculateConstitutiveSlipDerivative(
...
bool
CPKalidiniUpdate::areConstitutiveStateVariablesConverged()
{
...
void
CPKalidiniUpdate::updateSubstepConstitutiveVariableValues()
{
  // Would also set substepped dislocation densities here if included in this model
...
void
CPKalidiniUpdate::cacheStateVariablesBeforeUpdate()
{
  _slip_resistance_before_update = _slip_resistance[_qp];
}

void
CPKalidiniUpdate::calculateStateVariableEvolutionRateComponent()
{
  for (const auto i : make_range(_number_slip_systems))
  {
...
bool
CPKalidiniUpdate::updateStateVariables()
{
