...
[Materials]
  ...
  [./free_energy_solid]
    ...
    expression = 'mu*(gr0^4/4.0 - gr0^2/2.0 + gr1^4/4.0 - gr1^2/2.0 + cv^4/4.0 - cv^2/2.0 + beta_s*cv^2*(gr0^2 + gr1^2) + gamma_asymm*gr0^2*gr1^2) + 1/4'
    # expression = '1.0*(cv^4/4.0 - cv^2/2.0 + gr0^4/4.0 - gr0^2/2.0 + gr1^4/4.0 - gr1^2/2.0 + 1.5*cv^2*(gr0^2 + gr1^2) + 1.5*gr0^2*gr1^2)'
    derivative_order = 2
    enable_jit = true
  ...
  [./surface_mobility]
    ...
    constant_expressions = '1.0e-4 10'
     material_property_names = 'L'
    coupled_variables = 'cv'
    expression = '10*L/2*(Mb + 16*Ms*(1-cv)^2*cv^2)'
  ...
  #   type = ParsedMaterial
  #   prop_names = kappa_c
  #   material_property_names = 'kappa_op'
  #   expression = 'kappa_op'
  # [../]
  # [./free_energy_vapor]
  #   type = DerivativeParsedMaterial
  #   property_name = f_vapor
  #   coupled_variables = 'cv'
  #   material_property_names = 'mu gamma_asymm'
  #   expression = 'mu*(cv^4/4.0 - cv^2/2.0)'
  #   derivative_order = 2
  #   enable_jit = true
  # [../]
  # [./free_energy_interface]
  #   type = DerivativeParsedMaterial
  #   property_name = f_int
  #   coupled_variables = 'cv gr0 gr1'
  #   material_property_names = 'mu gamma_asymm'
  #   expression = '' # TODO
  # [../]
  # [./]
  ...
  #   expression = 'f_solid + 1/4'
  #   derivative_order = 2
  #   enable_jit = true

  #   output_properties = 'F dF/dgr0'
  #   outputs = my_exodus
  # [../]
[]
